...
// This will insert the implementation of chai into this file.
// Without this definition, chai will act like a simple header file.
#define CHAI_IMPLEMENTATION

#include "chai.h"
#include <stdio.h>

// This is the simplest way to create a new list type.
